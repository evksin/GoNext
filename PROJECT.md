...
## 8. Теги и поиск
Добавь систему тегов для мест, заметок и поездок (например, "еда", "приключения", "дешево") с мощным локальным поиском по тексту, фото и тегам.
Таким образом, пользователи смогут фильтровать все данные, например: "покажи все места с тегом 'пляж' за 2025 год".
​
